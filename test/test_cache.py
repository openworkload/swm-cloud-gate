...
class TestCache(unittest.TestCase):
    ...
    def test_load_from_filesystem(self):
        data, cache_file_path = self._cache._load_from_filesystem("test_data_kind", str(self._cache_dir))
        self.assertEqual(data, [])
        self.assertEqual(cache_file_path, Path(f"{self._cache_dir}/cloud-gate-test_data_kind.dat"))

        cache_file_path = Path(f"{self._cache_dir}/cloud-gate-test_data_kind.dat")
        now = datetime.now()
